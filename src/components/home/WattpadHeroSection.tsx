...
export function WattpadHeroSection() {
  return (
    <section className="relative overflow-hidden border-b border-border/60 bg-warm">
      <div
      ...
      <div className="relative mx-auto grid max-w-7xl gap-12 px-4 py-16 sm:px-6 sm:py-20 lg:grid-cols-2 lg:items-center lg:gap-16 lg:px-8 lg:py-24">
        ...
        <div className="relative mx-auto w-full max-w-md lg:max-w-none">
          <div className="relative rounded-3xl border border-border/60 bg-white p-6 shadow-xl shadow-primary/5">
            <div className="absolute -right-3 -top-3 rounded-2xl border border-border/60 bg-white p-3 shadow-lg">
              <MoonieMascot size={48} animated />
            </div>
